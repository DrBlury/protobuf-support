...
export class Proto3RenumberCommand {
  ...
  public static getDocumentTextEdits(document: vscode.TextDocument): vscode.TextEdit[] {
    return computeDocumentRenumberEdits(document.getText()).map(edit =>
      this.toWorkspaceTextEdit(document, edit)
    );
  }
  ...
  private static toWorkspaceTextEdit(
    document: vscode.TextDocument,
    edit: NumericEdit
  ): vscode.TextEdit {
